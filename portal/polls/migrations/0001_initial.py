...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'polls_department', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255)),
        ))
        db.send_create_signal(u'polls', ['Department'])

        # Adding model 'Question'
        db.create_table(u'polls_question', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(default=u'', max_length=1000)),
        ...
        db.create_table(u'polls_useranswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'user_answers', to=orm['portal.PortalUser'])),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'user_answers', to=orm['polls.Answer'])),
            ('department', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'user_answers', to=orm['polls.Department'])),
        ))
        db.send_create_signal(u'polls', ['UserAnswer'])


    def backwards(self, orm):
        # Deleting model 'Department'
        db.delete_table(u'polls_department')
        ...
        db.delete_table(u'polls_useranswer')
