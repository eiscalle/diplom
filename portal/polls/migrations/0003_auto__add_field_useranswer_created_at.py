...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAnswer.created_at'
        db.add_column(u'polls_useranswer', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAnswer.created_at'
        db.delete_column(u'polls_useranswer', 'created_at')
